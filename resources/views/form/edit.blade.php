...
<html>
	...
	<body>
		<form method="post" enctype="multipart/form-data" action="/register/update">
			<table border="0" align="center">
				<tr>
					<td>Enter First Name</td>
					<td>
						<input type="text" name="firstname" placeholder="Enter Your First Name" size="20" maxlength="10" value="{{ $row->firstname }}" />
					</td>
				</tr>
				<tr>
					<td>Enter Last Name</td>
					<td>
						<input type="text" name="lastname" placeholder="Enter Your Last Name" size="20" maxlength="20" value="{{ $row->lastname }}" />
					</td>
				</tr>
				<tr>
					<td>Enter Email Id</td>
					<td>
						<input type="email" name="email" placeholder="Enter Your Email" size="50" maxlength="100" value="{{ $row->email }}" />
					</td>
				</tr>
				<tr>
					<td>Enter Password</td>
					<td>
						<input type="password" name="password" placeholder="Enter Your Password" size="50" maxlength="50" value="{{ $row->password }}" />
					</td>
				</tr>
				<tr>
					<td>Gender</td>
				...
				<tr>
					...
					<td>
						...
						<input type="checkbox" name="hobbies[]" value="football"  @if(in_array("football",$hobbies)){{ 'checked' }} @endif  /> Football
						<input type="checkbox" name="hobbies[]" value="kabaddi" @if(in_array("kabaddi",$hobbies)){{ 'checked' }} @endif /> Kabaddi
					</td>
				</tr>
				<tr>
					<td></td>
